...
reanalysis to preposition; the \textit{Cambridge Grammar}
\parencite{cgel2002} weighs it differently~⟨VERIFY: confirm CGEL's
classification and section before this clause is kept⟩. The point here
isn't who's right. It's that both verdicts discard stable, replicable
facts as noise, because the adjudication game has no role for them.
