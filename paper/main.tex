...
take \mention{very}? Does it license an NP complement? Does it occur
...
\mention{utter} as much an adjective as \mention{thin}, just a less
...
analysed, and this introduction is written to survive any outcome,
...
flagged (\mention{worth}, \mention{near}, \mention{fun}, \mention{galore}),
...
troubles are best seen at category boundaries. \mention{Worth} licenses
an NP complement like a preposition (\mention{worth a fortune}), resists
\mention{very} (\mention{*very worth the trip}) while accepting
\mention{well} (\mention{well worth the trip}), inverting the pattern of
central adjectives, and occurs as complement
of \mention{become} like an adjective, with a gapped gerund-participial
complement (\mention{worth reading \underline{\hspace{1em}}}) that
clusters with adjectival \mention{tough}-constructions.
...
same conflicts and keeps \mention{worth} in the adjective category,
...
peculiar to \mention{worth}. The field's two most detailed treatments
invert each other on both flagship items: \textcite{maling1983} makes
\mention{worth} a preposition and \mention{near} an adjective
(\enquote{the only surviving relic of the class of transitive
adjectives}), while the \textit{Cambridge Grammar} makes \mention{worth}
an adjective and \mention{near} an exceptional preposition, and
\textcite{aarts2007} splits \mention{near} by syntactic configuration.
...
(\mention{worth}, \mention{near}, and the rest) behave under the winning model.}
...
discrete essence a word is in a category or out of it, so \mention{worth} and
\mention{near} should fit the reflective model as well as any central member.
...
noise does not. Hide the cell for \mention{worth} with \mention{very}, say: the
reflective model predicts it from where \mention{worth} sits on a shared adjective
dimension, the network model from \mention{worth}'s direct links to the other
...
\mention{worth}, \mention{near}, \mention{fun}, \mention{galore}, \mention{like},
\mention{due}, \mention{ablaze}, \mention{asleep}, \mention{more}, \mention{less},
\mention{enough}, \mention{such}, and \mention{own}, is predicted to land among the
...
work: the profiles of \mention{more} and \mention{less} should cluster with the
...
For independent acceptability judgments on the validation set, I thank
Michael DiPetta.
% ⟨pending: add the remaining panel raters (six total) as they report;
% returned files in rater_app/responses/⟩
